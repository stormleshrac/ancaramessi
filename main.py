    ...
    try:
        ...
        if '/start' in msgText:
            ...
            #    
                # set in debug
            #    api_id = 15332564
            #    api_hash = '5647a2b0e9ba980eff774dccd1cfcd18'
            #    bot_token = '5348130508:AAFAN0Bu1LEDKRxPvVL_NLILApZ5P4YapZM'
...
def main():
    ...
    #set in debug
    bot_token = '5727473328:AAFappOKWHGzYm4TwHFL4uvdlZ_Vh3eHKEc'
